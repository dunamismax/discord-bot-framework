...
class Database:
    ...
    async def get_user_data(self, user_id: int, guild_id: int | None = None) -> dict[str, Any]:
        """Get data for a user."""
        if guild_id:
            cursor = await self._connection.execute(
    ...
    async def set_user_data(self, user_id: int, data: dict[str, Any], guild_id: int | None = None):
        """Set data for a user."""
    ...
    async def log_command_usage(self, command_name: str, user_id: int, guild_id: int | None = None):
    ...
    async def get_playlist(self, playlist_id: int) -> dict[str, Any] | None:
...
class DatabaseMixin:
    ...
    async def setup_database(self, db_path: str | Path = None):
